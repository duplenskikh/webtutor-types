interface FactPaymentTopElem extends XmlTopElem<FactPaymentDocument>, FileListBase, CustomElemsBase {
  name?: XmlElem<string>;
...
type FactPaymentDocument = XmlDocument<FactPaymentTopElem>;
