...
type WorkflowDocumentRoot = {
  TopElem: XmlTopElem<WorkflowDocumentForm, WorkflowDocument>;
};

type WorkflowDocument = XmlDocument<WorkflowDocumentRoot>;