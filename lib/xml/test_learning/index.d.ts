interface TestLearningSection {
  id?: XmlElem<string>;
  title?: XmlElem<string>;
  score?: XmlElem<number>;
}

interface TestLearningTopElem extends XmlTopElem<TestLearningDocument>, PersonFillingBase, AnnalsObjectsBase, AnnalsNumsBase, LearningObjectivesInteractionsBase, AssessmentScaleValue, FileListBase, AdminAccessBase, CustomElemsBase {
  code?: XmlElem<string>;
  ...
  sections?: XmlMultiElem<TestLearningSection>;
  name?(): any;
}
