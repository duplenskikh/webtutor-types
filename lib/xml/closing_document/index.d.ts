interface ClosingDocumentExpense {
  expense_id?: XmlElem<number>;
}

interface ClosingDocumentTopElem extends XmlTopElem<ClosingDocumentDocument>, FileListBase {
  code?: XmlElem<string>;
  name?: XmlElem<string>;
  ...
  expenses?: XmlMultiElem<ClosingDocumentExpense>;
}

type ClosingDocumentDocument = XmlDocument<ClosingDocumentTopElem>;
