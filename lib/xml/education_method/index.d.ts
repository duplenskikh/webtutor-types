...
GameBonusBase & {
  ...
  id: XmlElem<number>;
  code: XmlElem<string>;
  resource_id: XmlElem<number, ResourceDocumentTopElem>;
  is_open: XmlElem<boolean>;
  default_request_type_id: XmlElem<number, RequestDocumentTopElem>;
  default_response_type_id: XmlElem<number, ResponseTypeDocumentTopElem>;
  mandatory_fill_response: XmlElem<boolean>;
  certificate_type_id: XmlElem<number, CertificateDocumentTopElem>;
  comment: XmlElem<string>;
  doc_info: XmlElem<DocInfoBase>;
  access: XmlElem<AccessDocBase>;
  event_form: XmlElem<string, typeof lists.event_forms>;
  event_type_id: XmlElem<number, EventTypeDocumentTopElem>;
