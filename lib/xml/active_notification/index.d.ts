...
type ActiveNotificationDocumentTopElem = XmlTopElem & { Doc: ActiveNotificationDocument } & {
...
type ActiveNotificationDocument = XmlDocument & { TopElem: ActiveNotificationDocumentTopElem; };
