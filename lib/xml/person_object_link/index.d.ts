interface PersonObjectLinkObject {
...
interface PersonObjectLinkTopElem extends XmlTopElem<PersonObjectLinkDocument> {
  code?: XmlElem<string>;
  ...
  objects?: XmlMultiElem<PersonObjectLinkObject>;
}

type PersonObjectLinkDocument = XmlDocument<PersonObjectLinkTopElem>;
