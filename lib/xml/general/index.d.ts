...
interface WorkflowDataBase {
  ...
  get_workflow_state_name?(): any;
  set_workflow_state_last_date?(): any;
  add_workflow_log_entry?(): any;
}
...
interface WorkflowFieldsStatesBaseWorkflowFieldEntriesEntry {
  value?: XmlElem<string>;
}
...
interface WorkflowFieldsStatesBaseWorkflowField {
  ...
  is_required?: XmlElem<boolean>;
  entries?: XmlElem<WorkflowFieldsStatesBaseWorkflowFieldEntries>;
}
...
interface FieldNamesBaseFieldName extends FieldNameBase {
  level?: XmlElem<number>;
  field_names?: XmlMultiElem<FieldNamesBaseFieldNameFieldName>;
}
