interface WorkingConditionAdditionalPayment {
  id?: XmlElem<string>;
...
interface WorkingConditionBenefit {
  benefit_id?: XmlElem<number>;
  comment?: XmlElem<string>;
}

interface WorkingConditionTariffRate {
  tariff_rate_value?: XmlElem<number>;
  currency_type_id?: XmlElem<string>;
  tariff_rate_type_id?: XmlElem<string>;
}

interface WorkingConditionView extends DescBase {
}

interface WorkingConditionTopElem extends XmlTopElem<WorkingConditionDocument>, PersonFillingBase, FileListBase, CustomElemsBase {
  id?: XmlElem<number>;
  code?: XmlElem<string>;
  name?: XmlElem<string>;
  ...
  additional_payments?: XmlMultiElem<WorkingConditionAdditionalPayment>;
  benefits?: XmlMultiElem<WorkingConditionBenefit>;
  tariff_rate?: XmlElem<WorkingConditionTariffRate>;
  view?: XmlElem<WorkingConditionView>;
}

type WorkingConditionDocument = XmlDocument<WorkingConditionTopElem>;
