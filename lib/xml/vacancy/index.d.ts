interface VacancyAssessment {
  assessment_id?: XmlElem<number>;
  assessment_name?: XmlElem<string>;
  assessment_code?: XmlElem<string>;
}

interface VacancyView extends DescBase {
}

interface VacancyTopElem extends XmlTopElem<VacancyDocument>, ObjectCodeNameBase, AdminAccessBase, FileListBase, CustomElemsBase {
  ...
  assessments?: XmlMultiElem<VacancyAssessment>;
  access?: XmlElem<AccessDocBase>;
  view?: XmlElem<VacancyView>;
}

type VacancyDocument = XmlDocument<VacancyTopElem>;
