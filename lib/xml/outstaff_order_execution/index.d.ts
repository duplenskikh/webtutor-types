interface OutstaffOrderExecutionStage extends CostCurrencyBase, CustomElemsBase {
  id?: XmlElem<string>;
...
interface OutstaffOrderExecutionView extends DescBase {
}

interface OutstaffOrderExecutionTopElem extends XmlTopElem<OutstaffOrderExecutionDocument>, PersonFillingBase, FileListBase, AdminAccessBase, CustomElemsBase {
  id?: XmlElem<number>;
  code?: XmlElem<string>;
  ...
  stages?: XmlMultiElem<OutstaffOrderExecutionStage>;
  access?: XmlElem<AccessDocBase>;
  view?: XmlElem<OutstaffOrderExecutionView>;
  name?(): any;
  update_stages?(): any;
}

type OutstaffOrderExecutionDocument = XmlDocument<OutstaffOrderExecutionTopElem>;
