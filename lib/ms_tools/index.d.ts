declare namespace ms_tools {
  ...
  function init_task_data(teTaskInfo: unknown, delay: number): unknown;
  ...
  function set_task(taskId: string, teTaskInfo: unknown): unknown;
  function set_task_data(taskId: string, teTaskInfo: unknown): unknown;
  ...
  function create_resource_admin(url: string, teSource: unknown, screen: unknown): unknown;
  ...
  function disp_application_view_configuration(teApplication: unknown, viewConfigurationId: string, elemType: string, menuElem: unknown, noTab: boolean, onlyUrl: boolean): unknown;
