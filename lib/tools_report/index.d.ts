declare namespace tools_report {
  ...
  function statistic_report(str: unknown): unknown;
  ...
  function competence_by_depart_report(str: unknown): unknown;
  function event_dep_report(str: unknown, curUser: CurUser): unknown;
  function budget_report(xml: string): unknown;
  function request_report(params: unknown): unknown;
  function server_log_report(str: unknown): unknown;
  function education_method_report(str: unknown): unknown;
  function event_by_depart_report(str: unknown, curUser: CurUser): unknown;
  function budget_transfers_report(): unknown;
  function course_by_depart_report(str: unknown): unknown;
  function test_by_depart_report(str: unknown): unknown;
  function certificate_type_report(params: unknown): unknown;
  function test_report(str: unknown, curUserId: number, applicationId: number): unknown;
  function course_objectives_report(params: unknown): unknown;
  function course_module_report(params: unknown): unknown;
  function question_by_depart_report(str: unknown): unknown;
  function event_person_report(str: unknown, curUser: CurUser): unknown;
  ...
  function learning_statistics_report(str: unknown): unknown;
  function course_integral_efficiency_report(str: unknown): unknown;
  function questions_analytics_report(str: unknown): unknown;
  function course_comment_report(str: unknown): unknown;
  function course_module_status_report(str: unknown): unknown;
  function get_report_data(url: string, switchForm: boolean, reportName: string): unknown;
  function career_reserve_report(str: unknown): unknown;
  ...
  function recommender_use_report(str: unknown): unknown;
  function recommender_compare_report(str: unknown): unknown;
}
