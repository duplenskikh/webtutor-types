declare namespace tools_soc {
  ...
  function obtain_individual_blog(objectId: number, teObject: unknown): unknown;
  function create_individual_blog_entry(type: string, objectId: number, userId: number, text: string, targetId: number, teObject: unknown, teUser: unknown, teTarget: unknown, arrAccessGroups: unknown): unknown;
  function get_user_soc_groups(curUserId: number, curUser: CurUser): unknown;
  function set_social_wall_item(teFormTarget: unknown, env: unknown, arrItems: unknown, arrLikes: unknown): unknown;
  ...
  function get_social_item_object(session: Session, wallItemId: number, teObject: unknown): unknown;
