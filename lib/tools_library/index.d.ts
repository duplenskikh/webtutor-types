declare namespace tools_library {
  ...
  function import_resource_by_source_type(sourceTypeId: number, resourceId: number, libraryMaterialId: number, auxName?: string | null): ReturnType<typeof import_file_by_source_type>;
  function import_file_by_source_type(sourceTypeId: number, fileUrl: string, libraryMaterialId: number, auxName?: string | null): unknown;
  ...
  function convert_to_simple_html(html: string, sourceFile: string, applyGlobalCutter: boolean, setTags: boolean): string[] | string;
  ...
  function GetLibraryObjectsList(rootId: number, personId: number, session: Session, sectionSortField: string, curLngId: string, addAll: boolean, extrafields: boolean): GetLibraryObjectsListResultItem[];
