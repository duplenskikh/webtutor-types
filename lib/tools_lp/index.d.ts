declare namespace tools_lp {
  ...
  function fill_context(xarrStatisticRecs: unknown, isObject: boolean, env: unknown, teWebMode: unknown): unknown;
  function get_context(catalogName: string, isObject: boolean, env: unknown): unknown;
  function get_web_mode_context(teWebMode: unknown, env: unknown, arrContextCodes: unknown): unknown;
  ...
  function owt_wvars_to_json(teOWT: unknown, basicParamsOnly: boolean): unknown;
  function plain_wvars_to_json(teDoc: unknown, basicParamsOnly: boolean): unknown;
  ...
  function get_runtime_data_from_cache(teOWT: unknown, skipCache: boolean): unknown;
  function get_html_from_cache(teOWT: unknown, skipCache: boolean): unknown;
  ...
  function save_template_cache(teWebMode: unknown, text: string, siteId: number, locale: string): unknown;
  function get_template_cache(teWebMode: unknown, siteId: number, locale: string): unknown;
  function replace_template_cache(teWebMode: unknown, text: string, request: unknown): unknown;
