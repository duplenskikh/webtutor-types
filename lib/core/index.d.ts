 ...
 *
 * @returns Undefined
 * Если поток вызывает в цикле функцию Sleep() либо любую функцию, вызывающее сетевой запрос,
 * то вызывать функцию CheckCurThread() нет необходимости, поскольку вышеназванные функции
 ...
 * начатым при помощи функции StartModalTask().
 *
 * @returns Undefined.
 */
 ...
 * В противном случае функция работает аналогично ArraySelectAll() и возвращает массив типа Array,
 ...
 * что делает эту функцию существенно быстрее по сравнению с ArraySelectByKey().
 * @param {Array} array - Массив.
 * @param {string} value - Значение ключа.
...
/**
 * Удаляет все зарегистрированные при помощи фукции RegisterFormMapping() перенаправления форм.
 ...
 * Действие функции аналогично действию функции HtmlEncode(), но,
 * в отличие от последней, HtmlEncodeDoc() формирует завершенный HTML-документ,
