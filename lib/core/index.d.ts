 ...
 *
 * @returns Undefined
 * Если поток вызывает в цикле функцию {@link Sleep}() либо любую функцию, вызывающее сетевой запрос,
 * то вызывать функцию {@link CheckCurThread}() нет необходимости, поскольку вышеназванные функции
