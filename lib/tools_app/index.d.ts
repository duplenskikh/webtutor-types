declare namespace tools_app {
  ...
  function get_cur_application(applicationId: number, applicationInstanceId: number, objectId: number, teObject: unknown): unknown;
  let cur_application_instance: XmlElem<unknown>;
  function get_cur_application_instance(applicationId: number, applicationInstanceId: number, objectId: number, teObject: unknown): unknown;
  function set_cur_application_instance(applicationInstanceId: number, teApplicationInstance: unknown): unknown;
  ...
  function get_cur_application_lib(applicationId: number, applicationInstanceId: number, objectId: number, teObject: unknown): unknown;
  ...
  function get_cur_settings(name: string, target: string, format: string, applicationId: number, applicationInstanceId: number, objectId: number, teObject: unknown): unknown;
  ...
  function save_application_settings(applicationId: number, teSettings: unknown): unknown;
